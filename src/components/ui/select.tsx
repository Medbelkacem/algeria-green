...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        "flex h-11 w-full items-center justify-between gap-2 rounded-lg border bg-background px-3 py-2 text-sm shadow-xs outline-none",
        ...
        "[&_svg]:size-4 [&_svg]:shrink-0 [&>span]:truncate [&>span]:text-start",
        className,
      )}
      {...props}
    >
...
function SelectItem({ className, children, ...props }: React.ComponentProps<typeof SelectPrimitive.Item>) {
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-2 rounded-md py-2 pe-8 ps-2 text-sm outline-none select-none",
